...
public interface ProjectService {
    ProjectResponse createProject(ProjectCreateRequest request, UUID organisationId) throws Exception;
    Page<ProjectResponse> getAllProjectsFromOrganisation(UUID organisationId, int page, int size) throws ItemNotFoundException;
