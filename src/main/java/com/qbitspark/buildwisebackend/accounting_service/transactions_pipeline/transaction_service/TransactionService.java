package com.qbitspark.buildwisebackend.accounting_service.transactions_pipeline.transaction_service;
...
/**
 * Main service interface for processing accounting transactions_pipeline.
 *
 * This is the public API that controllers and other services use to create
 * accounting transactions_pipeline. It orchestrates all 6 layers of our transaction
...
public interface TransactionService {
     ...
     *
     * For transactions_pipeline that need management approval before being posted.
     *
