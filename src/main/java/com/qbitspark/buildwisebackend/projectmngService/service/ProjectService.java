...
//    TeamMemberResponse getOrganisationProjectMember(UUID organisationId, UUID memberId, UUID requesterId) throws ItemNotFoundException;
    ...
    TeamMemberResponse getCurrentUserDetails(UUID organisationId, UUID requesterId) throws ItemNotFoundException;

    List<TeamMemberResponse> getProjectTeamMembers(UUID projectId) throws ItemNotFoundException;
}